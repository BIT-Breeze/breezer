...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <hr>
      ...
      <c:choose>
        ...
        <li class="active"><a href="${pageContext.servletContext.contextPath }/hongseok5@gmail.com">Main</a></li>
        ...
        <li><a href="${pageContext.servletContext.contextPath }/hongseok5@gmail.com">Main</a></li>
